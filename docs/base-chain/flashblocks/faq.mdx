...
Base targets a Flashblock reorg rate SLO of **99.9%** (< 0.1% reorgs). While reorgs are rare, applications should implement fallback logic for critical operations. Check current metrics at [base.org/stats](https://base.org/stats).
