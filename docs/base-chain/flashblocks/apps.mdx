...
Flashblocks enable **200 millisecond** transaction confirmations on Base through preconfirmations—ultra-fast signals that arrive before the full 2-second block is sealed.
