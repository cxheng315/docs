...
<Info>
For detailed response schema documentation (Flashblock, Diff, Metadata, Receipt, Log objects), see the [WebSocket Reference](/base-chain/flashblocks/websocket-reference#schema). Note: The `metadata` object is **not stable** and may change without notice.
</Info>
